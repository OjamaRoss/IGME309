...
void AppClass::ProcessKeyboard(sf::Event a_event)
{
	if (a_event.key.code == sf::Keyboard::Key::Escape)//Event says I pressed the Escape key
		...
		m_v3Complimentary = !m_v3Complimentary;
}
void AppClass::Display(void)
{
	...
	GLuint ComplimentColor = glGetUniformLocation(m_uShaderProgramID, "Compliment");
	glUniform1i(ComplimentColor, m_v3Complimentary);
