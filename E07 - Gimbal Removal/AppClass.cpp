...
void Application::InitVariables(void)
{
	...
	m_sProgrammer = "Alec Musselman - adm4906@g.rit.edu";
...
void Application::Display(void)
{
	...
	*/
	...
	m_qOrientation *= glm::quat(glm::rotate(glm::radians(m_v3Rotation.x), vector3(1.0f, 0.0f, 0.0f)));
	m_qOrientation *= glm::quat(glm::rotate(glm::radians(m_v3Rotation.y), vector3(0.0f, 1.0f, 0.0f)));
	m_qOrientation *= glm::quat(glm::rotate(glm::radians(m_v3Rotation.z), vector3(0.0f, 0.0f, 1.0f)));
